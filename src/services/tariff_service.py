...
class TariffService:
    ...
    def update_flat_demand_rate(
        ...
        if flat_demand_rates and flat_demand_months and month_index < len(flat_demand_months):
        ...
        try:
            ...
            if 'energyratestructure' in tariff:
                ...
                if not isinstance(energy_rates, list):
                    validation_results['errors'].append("Energy rate structure must be a list")
                    validation_results['is_valid'] = False
            ...
            if len(weekday_schedule) != 12:
                validation_results['warnings'].append("Weekday schedule should have 12 months")
            
            if len(weekend_schedule) != 12:
                validation_results['warnings'].append("Weekend schedule should have 12 months")
            ...
            if 'demandratestructure' in tariff and tariff['demandratestructure']:
                ...
                if len(demand_weekday_schedule) != 12:
                    validation_results['warnings'].append("Demand weekday schedule should have 12 months")
                
                if len(demand_weekend_schedule) != 12:
                    validation_results['warnings'].append("Demand weekend schedule should have 12 months")
    ...
    def get_tariff_summary(tariff_viewer: TariffViewer) -> Dict[str, Any]:
        ...
        summary = {
            ...
            'energy_rates': {
                ...
                'avg': sum(all_energy_rates) / len(all_energy_rates) if all_energy_rates else 0
            },
            'demand_rates': {
                ...
                'avg': sum(all_demand_rates) / len(all_demand_rates) if all_demand_rates else 0
            },
            'flat_demand_rates': {
                ...
                'avg': sum(flat_demand_rates) / len(flat_demand_rates) if flat_demand_rates else 0
            }
        }
