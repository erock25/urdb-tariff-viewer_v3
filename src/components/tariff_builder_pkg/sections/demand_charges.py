...
from .schedules import _render_simple_schedule_editor, _render_advanced_schedule_editor, _show_schedule_heatmap
...
def render_demand_charges_section() -> None:
    ...
    st.info("💡 **Tip**: If your tariff has hours when no TOU-based demand charge applies, "
